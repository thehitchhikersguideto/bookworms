...
export default function AboutUsSection() {
  const members = [
    ...
    { name: 'Zane Reda', role: 'Product Owner', link: 'https://www.linkedin.com/in/zane-reda-0992b3211/', image: require('/Users/fheshiki/Documents/GitHub/gymworkouts/frontend/workout-reco-app/src/images/zane.jpg')}
  ];
