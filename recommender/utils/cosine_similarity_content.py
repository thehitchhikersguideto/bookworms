...
def DR_by_grouping(df_books_and_embeddings, min_freq=10):
...
def get_cosine_recommendations(user_books_ids = ['77203.The_Kite_Runner', '929.Memoirs_of_a_Geisha', '128029.A_Thousand_Splendid_Suns', '19063.The_Book_Thief', '4214.Life_of_Pi'], user_ratings = [4, 4, 3, 5, 4], books_to_return=3):
    ...
    print("checkpoitnt 1")
    # Reduce the number of authors and publishers
    df_books_and_embeddings = DR_by_grouping(df_books_and_embeddings)
    ...
    # Convert the rating column to float32, used if we just want this recommendation system
